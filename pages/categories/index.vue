<template>
    <div class="flex justify-between items-center ">
        ...
        <div>
            ...
            class="border-2 py-1 px-4 border-slate-800 rounded-md hover:bg-slate-800 hover:text-white transition-all duration-200"> ایجاد دسته</NuxtLink>
        </div>
    </div>
    <hr class="my-4">
...
const {data, refresh} = await useFetch('/api/global', {
    ...
    query: {url: "/categories", page: page}
})
